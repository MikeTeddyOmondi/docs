# Tide | Rust RESTful API

Content:

1. Documentation: README.md

2. Middlewares: logging, CSRF, flashes, telemetry

3. Authentication: JWT, Oauth2.0, 

4. Session store: Redis, MongoDB

5. Persistence: SQLite/MySQL/PostgreSQL & MongoDB 
